...
const images = [
    { id: 1, img: Backpack, text: "Schaut mal, Leute, diese Person hat ihren Rucksack nicht sicher aufbewahrt 🔒 ... er gehört jetzt mir, haha" },
        ...
        {selectedImage ? (
            <div className="ImageScrollContainer">
                ...
                <div>
                    <ImageGallery
                    images={images}
                    selectedIndex={images.findIndex((img) => img.id === selectedImage.id)}
